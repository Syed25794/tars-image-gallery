  ...
  return (
    <Box bgImage="url('./HeroSectionImage3.jpg')"  bgSize="cover" bgPosition="center" height={["25rem","30rem","40rem"]}  display="flex" flexDir="column" justifyContent="center" alignItems="center" gap={["0.5rem","0.8rem","1rem"]}>
      ...
      <InputGroup fontFamily="Monstserrat" w="75%"  h="3rem">
        ...
        <Input onKeyDown={handleKeyDown} list="options" value={searchQuery} onChange={searchImages} border="1px solid black" borderRadius="0.5rem" h="full" bgColor="white" type="text" fontSize="lg" placeholder="Search high resolution Images, categories, wallpapers" />
      </InputGroup>
      <datalist id="options">
